...
State{
        ...
        timeline=
        {
            ...
            TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/characters/walter/woby/big/bark") end),
        },
...
return StateGraph("arong_dog", states, events, "idle", actionhandlers)