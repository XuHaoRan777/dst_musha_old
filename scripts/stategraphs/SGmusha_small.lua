	...
	--test
	 --[[State{
        ...
        onenter = function(inst)
            ...
            inst.AnimState:AddOverrideBuild("arong_big_build")
        ...
        timeline = 
        {
            ...
            TimeEvent(1*FRAMES, function(inst) inst.Transform:SetScale(.65, .65, .65) 
			inst:Finish_arong_Transformation()
			end),
...
CommonStates.AddWalkStates(states,
{
        walktimeline =
        {
            TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/creatures/together/perdling/walk") end),
