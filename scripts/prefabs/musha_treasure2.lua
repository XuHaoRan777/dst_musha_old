...
chest1.components.container:GiveItem(item5)
	...
	elseif math.random() < 0.3 then
		local item6 = SpawnPrefab("glowdust")
...
local item8 = SpawnPrefab("tunacan_musha")	
local item9 = SpawnPrefab("portion_e")
chest1.components.container:GiveItem(item1)
chest1.components.container:GiveItem(item2)
chest1.components.container:GiveItem(item3)
...
chest1.components.container:GiveItem(item9)
		...
		local item16 = SpawnPrefab("tunacan_musha")	
		local item17 = SpawnPrefab("tunacan_musha")	
		local item18 = SpawnPrefab("tunacan_musha")	
		local item19 = SpawnPrefab("tunacan_musha")	
		local item20 = SpawnPrefab("tunacan_musha")	
		chest1.components.container:GiveItem(item10)
...
chest1.components.container:GiveItem(item9)
	if math.random() < 0.5 then
		...
		local item13 = SpawnPrefab("beefalowool")	
		local item14 = SpawnPrefab("beefalowool")	
		local item15 = SpawnPrefab("tunacan_musha")	
		local item16 = SpawnPrefab("tunacan_musha")	
		local item17 = SpawnPrefab("tunacan_musha")	
		local item18 = SpawnPrefab("tunacan_musha")	
		local item19 = SpawnPrefab("tunacan_musha")	
...
local item5 = SpawnPrefab("tunacan_musha")	
local item6 = SpawnPrefab("tunacan_musha")	
local item7 = SpawnPrefab("tunacan_musha")	
local item8 = SpawnPrefab("tunacan_musha")	
local item9 = SpawnPrefab("tunacan_musha")	
chest1.components.container:GiveItem(item1)
chest1.components.container:GiveItem(item2)
chest1.components.container:GiveItem(item3)
chest1.components.container:GiveItem(item4)
...
chest1.components.container:GiveItem(item9)
	if math.random() < 0.5 then
		local item10 = SpawnPrefab("tunacan_musha")	
		local item11 = SpawnPrefab("tunacan_musha")	
		local item12 = SpawnPrefab("tunacan_musha")	
		local item13 = SpawnPrefab("tunacan_musha")	
		local item14 = SpawnPrefab("tunacan_musha")	
		local item15 = SpawnPrefab("tunacan_musha")	
		local item16 = SpawnPrefab("tunacan_musha")	
		local item17 = SpawnPrefab("glowdust")	
		local item18 = SpawnPrefab("glowdust")	
