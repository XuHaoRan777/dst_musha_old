...
inst.yamche = false
	if not inst.components.follower.leader then 
		inst.MiniMapEntity:SetIcon( "moontree_musha.tex" )
...
--v.AnimState:PlayAnimation("exit")
	...
	local x,y,z = inst.Transform:GetWorldPosition()
local ents = TheSim:FindEntities(x,y,z, 15, {"wild_veggie"})
for k,v in pairs(ents) do
if inst.sleep_on and v.components.follower and not v.components.follower.leader and not inst.components.leader:IsFollower(v) then 
inst.components.leader:AddFollower(v)
end 
...
if inst.level1 then
if inst.components.leader:CountFollowers("wild_veggie") >= 1 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 1 then inst.full_carrot = false end
elseif inst.level2 then
if inst.components.leader:CountFollowers("wild_veggie") >= 1 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 1 then inst.full_carrot = false end
elseif inst.level3 then
if inst.components.leader:CountFollowers("wild_veggie") >= 2 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 2 then inst.full_carrot = false end
elseif inst.level4 then
if inst.components.leader:CountFollowers("wild_veggie") >= 2 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 2 then inst.full_carrot = false end
elseif inst.level5 then
if inst.components.leader:CountFollowers("wild_veggie") >= 3 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 3 then inst.full_carrot = false end
elseif inst.level6 then
if inst.components.leader:CountFollowers("wild_veggie") >= 3 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 3 then inst.full_carrot = false end
elseif inst.level7 then
if inst.components.leader:CountFollowers("wild_veggie") >= 4 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 4 then inst.full_carrot = false end
elseif inst.level8 then
if inst.components.leader:CountFollowers("wild_veggie") >= 4 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 4 then inst.full_carrot = false end
elseif inst.level9 then
if inst.components.leader:CountFollowers("wild_veggie") >= 5 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 5 then inst.full_carrot = false end
elseif inst.level10 then
if inst.components.leader:CountFollowers("wild_veggie") >= 5 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 5 then inst.full_carrot = false end
elseif inst.level11 then
if inst.components.leader:CountFollowers("wild_veggie") >= 6 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 6 then inst.full_carrot = false end
elseif inst.level12 then
if inst.components.leader:CountFollowers("wild_veggie") >= 6 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 6 then inst.full_carrot = false end
elseif inst.level13 then
if inst.components.leader:CountFollowers("wild_veggie") >= 7 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 7 then inst.full_carrot = false end
elseif inst.level14 then
if inst.components.leader:CountFollowers("wild_veggie") >= 7 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 7 then inst.full_carrot = false end
elseif inst.level15 then
if inst.components.leader:CountFollowers("wild_veggie") >= 8 then inst.full_carrot = true
elseif inst.components.leader:CountFollowers("wild_veggie") < 8 then inst.full_carrot = false end
end
if not inst.sleep_on and not v.move then
v.move = true
v.components.follower:SetLeader(nil)
...
return Prefab("moontree_musha", common_fn, assets, prefabs),
	MakePlacer("moontree_musha_placer", "leif", "leif_moon_build", "idle")
