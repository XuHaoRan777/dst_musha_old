...
local assets=
{
	Asset("ANIM", "anim/musha_egg_arong_arong.zip"),
	Asset("ATLAS", "images/inventoryimages/musha_egg_arong_arong.xml"),
	Asset("IMAGE", "images/inventoryimages/musha_egg_arong_arong.tex"),
	Asset("IMAGE", "images/inventoryimages/musha_egg_cracked_arong_arong.tex"),
	Asset("ATLAS", "images/inventoryimages/musha_egg_cracked_arong_arong.xml"),
	Asset("ATLAS", "images/inventoryimages/musha_egg_arong_arong_cooked.xml"),
...
----------------
local function AddMushaSpecific(inst)
...
local function Hatch(inst)
    local yamchebird = SpawnPrefab("arong_baby")
    yamchebird.Transform:SetPosition(inst.Transform:GetWorldPosition())
    yamchebird.sg:GoToState("grow_up")
...
local inst = CreateEntity()
    ...
    inst._musha_hatch_build = "musha_egg_arong"
	...
	if cookable then
        ...
        inst.components.cookable.product = "musha_egg_arong_cooked"
    end
	
	AddMushaSpecific(inst)
...
return Prefab( "common/inventory/musha_egg_arong", normalfn, assets, prefabs),
		Prefab( "common/inventory/musha_egg_cracked_arong", crackedfn, assets),
		Prefab("musha_egg_arong_cooked", cookedfn, assets)
