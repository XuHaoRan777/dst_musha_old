...
if eater.components.stamina_sleep ~= nil then
eater.components.fatigue_sleep:SetPercent(0)
eater.components.stamina_sleep:DoDelta(90)
end
if eater.components.spellpower ~= nil then
eater.components.spellpower:DoDelta(100)
end
end
