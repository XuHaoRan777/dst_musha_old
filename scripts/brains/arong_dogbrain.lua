    ...
    local root = PriorityNode(
    {
        ...
        WhileNode(function() return false end, "OnFire", -- TODO add the fire case again
            Panic(self.inst)),
				...
				--[[WhileNode( function() return self.inst.components.health:GetPercent() >= 0.25 and self.inst.components.follower.leader.components.health:GetPercent() <= 0.75 end, "AttackMomentarily", ChaseAndAttack(self.inst, 9,12) ),]]
